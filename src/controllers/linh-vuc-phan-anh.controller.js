...
const LinhVucPhanAnhController = {
  async createLinhVucPhanAnh(req, res) {
    const { ten, moTa, nguoiQuanLyIds = [] } = req.body;
    const currentUser = req.payload.userId;
    const result = await LinhVucPhanAnhService.createLinhVucPhanAnh(
      ten,
      moTa,
      nguoiQuanLyIds,
      currentUser
  ...
  async getAllLinhVucPhanAnh(req, res) {
    ...
    page = parseInt(page);
    size = parseInt(size);
    const result = await LinhVucPhanAnhService.getAllLinhVucPhanAnh(
      page,
      size,
      search,
      isActive
  ...
  async updateLinhVucPhanAnh(req, res) {
    ...
    const { ten, moTa, nguoiQuanLyIds } = req.body;
    const currentUser = req.payload.userId;
    const result = await LinhVucPhanAnhService.updateLinhVucPhanAnh(
      id,
      ten,
      moTa,
      nguoiQuanLyIds,
  ...
  async updateLinhVucPhanAnhStatus(req, res) {
    ...
    const currentUser = req.payload.userId;
    const result = await LinhVucPhanAnhService.updateLinhVucPhanAnhStatus(
      id,
      isActive,
      currentUser
    );
    return successResponse(
      res,
      result,
      "Cập nhật trạng thái lĩnh vực phản ánh thành công"
    );
  },
  ...
  async getLinhVucPhanAnhById(req, res) {
    ...
    return successResponse(
      res,
      result,
      "Lấy chi tiết lĩnh vực phản ánh thành công"
    );
  },
  ...
  async searchLinhVucPhanAnhByName(req, res) {
    ...
    return successResponse(
      res,
      result,
      "Tìm kiếm lĩnh vực phản ánh thành công"
    );
  },
};
