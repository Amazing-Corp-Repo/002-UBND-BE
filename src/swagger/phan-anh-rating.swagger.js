const PhanAnhRatingSwagger = {
  ...
  "/api/phan-anh-ratings/by-code/{complaintCode}": {
    get: {
      ...
      description: "API công khai cho người dân kiểm tra xem phản ánh đã được giải quyết chưa, đã được đánh giá chưa và thông tin đánh giá nếu có.",
      parameters: [
        {
          name: "complaintCode",
          in: "path",
          required: true,
          schema: { type: "string", pattern: "^[A-Z0-9]{8}$", example: "PA260010" },
        },
      ],
      responses: {
        200: { description: "Lấy thông tin đánh giá phản ánh thành công" },
        400: { description: "Mã phản ánh không hợp lệ (phải đúng 8 ký tự alphanumeric)" },
        404: { description: "Không tìm thấy mã phản ánh" },
      },
    },
  },
