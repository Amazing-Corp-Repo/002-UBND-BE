...
const env = {
    ...
    RATE_LIMIT_WRITE_MAX: process.env.RATE_LIMIT_WRITE_MAX,
    ...
    RATE_LIMIT_UPLOAD_VIDEO_MAX:
        process.env.RATE_LIMIT_UPLOAD_VIDEO_MAX ||
        process.env.REATE_LIMIT_FOR_UPLOAD_VIDEO_MAX,
